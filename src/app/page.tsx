...
export const metadata: Metadata = {
    alternates: {
        canonical: 'https://jplate.github.io/home',
    },
};
...
export default function HomePage() {
    const structuredData = {
        ...
        sameAs: ['https://jplate.github.io/home', 'https://openscholarship.wustl.edu/etd/1017/'],
        knowsAbout: [
            'Metaphysics',
            'Philosophical Logic',
            'Type Theory',
        ...
        image: 'https://jplate.github.io/home/icon.svg',
    };
